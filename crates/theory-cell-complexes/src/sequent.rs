...
impl CellMeta
{
    ...
    /// (`compose_directed`, `gandr_theory_decomposition_spaces::compose`)
    /// reads.
    ///
...
///
/// The positions a command cell can fire at: the seam is the root. This is the
/// sequent alphabet's realization of [`CellAlphabet::command_positions`].
///
/// # Contract
