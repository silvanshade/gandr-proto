//! Generative walk-index front-end over the graph substrate's walk engine.
//!
//! The walk engine is a declarative finite walk machine: callers
...
//! generative front-end that instantiates the
...
//!
//! **Design note (profiled).** The literal per-tile operator comparison
...
//! this scale; the bottleneck was profiled and attributed to the eager closure,
//! and the front-end was optimized to the group-representative form above with
//! `gandr-theory-graphs` left unmodified.
...
///   checks.
/// - provides: the generative walk front-end that replaces the placeholder
///   direct-row projection.
...
/// - provides: the recorded verdict for the walk-index profile.
