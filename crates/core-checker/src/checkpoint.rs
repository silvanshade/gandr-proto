...
/// generalization a session with a non-empty base would use).
///
/// # Contract
...
///
/// Against the empty base context; see [`resume_with`] for an explicit base.
///
/// # Contract
...
/// heap-stacked typing machine ([`crate::machine`], ADR-47) to completion.
///
/// # Contract
