...
//! Deterministic record-safe chunk boundary detection for Prolly-Bao
//! ordered-record trees.
//!
//! # Provenance
//!
...
/// The version-1 Gear table, generated by the `SplitMix64` source documented in
/// this crate.
...
{
    /// The first deterministic local Gear table profile.
...
/// Returns the version-1 Gear table's value for a byte.
///
/// # Contract
