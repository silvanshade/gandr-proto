...
//!
//! [`prim_address`]: gandr_theory_deep_inference::normal_form::prim_address
//! [`cell_address`]: gandr_theory_deep_inference::normal_form::cell_address
//! [`causal_past_address`]: gandr_theory_deep_inference::normal_form::causal_past_address
//! [`PrimId`]: gandr_theory_deep_inference::normal_form::PrimId
...
use gandr_theory_cell_complexes::pattern::Cat;
...
use gandr_theory_cell_complexes::sequent::CellMeta;
use gandr_theory_cell_complexes::sequent::CellProvenance;
use gandr_theory_cell_complexes::sequent::CellVariance;
...
use gandr_theory_deep_inference::normal_form::PrimCert;
...
///
/// The mirror of
/// [`gandr_theory_deep_inference::normal_form::NormalFormObstruction`] at the
...
pub enum TransportStepObstruction<A: CellAlphabet = SequentAlphabet>
{
    ...
    /// [`gandr_theory_deep_inference::normal_form::NormalFormObstruction::ContentAddressCollision`]
...
/// no path from a [`gandr_theory_deep_inference::normal_form::PrimId`] to a
/// [`TransportStepId`] — the in-process label is never an input, here or
/// anywhere.
///
/// # Contract
...
/// multiplicities exactly as
/// [`gandr_theory_deep_inference::normal_form::normalize`]'s factorization does
/// (saturating at the width). Two **distinct** primitives under one identity
/// are a collision and are refused.
///
/// # Contract
...
/// mirroring [`gandr_theory_deep_inference::normal_form::normalize`]'s insert:
/// a vacant key takes the entry, an equal certificate under a shared key has
/// the gradings summed (saturating at the width), and a distinct certificate
/// under a shared key is a refused collision.
///
/// # Contract
...
mod tests
{
    ...
    use gandr_theory_deep_inference::normal_form::normalize;
