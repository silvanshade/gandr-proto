...
- The toy alphabet supplies genuinely independent nested positions, including the two-member replay level used to verify order-independent planned replay.
