...
* `current`: Removed four `boundary` wrappers that named the extracted engine's vocabulary and had no use site: `AdoptedItemCount`, `ItemAdoption`, `SourceOrder`, and `NameOccurrenceCount`.
