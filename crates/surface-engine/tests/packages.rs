...
mod tests
{
    ...
    fn item_term(
        source: TestText<'_>,
        name: TestText<'_>,
    ) -> Result<gandr_core_term::syntax::Term, LowerError>
    {
        let source = source.0;
        let name = name.0;
    ...
    ) -> Comp
    {
        ...
        let gandr_core_term::syntax::Term::Value(Value::Thunk(_, body)) = term
        else {
    ...
    fn the_three_forms_lower_to_the_core_package_nodes()
    {
        ...
        let gandr_core_term::syntax::Term::Value(Value::Pack { ref witnesses, .. }) = make
        else {
    ...
    fn sole_unpack_atom(comp: &Comp) -> gandr_core_term::types::SealId
    {
    ...
    fn nested_unpack_atom(comp: &Comp) -> gandr_core_term::types::SealId
    {
