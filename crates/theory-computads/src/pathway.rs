...
//! as [`crate::completion`]. The frontier is what a later continuation would
//! need; this module exposes no entry point that takes one back, so a declined
//! query is **re-asked with a larger budget** rather than resumed in place.
...
use crate::normal_form::NormalFormObstruction;
...
mod tests
{
    ...
    ) -> Tracelet
    {
        ...
        let crate::tracelet::ReplayPathOutcome::Reached(reached) =
    ...
    fn every_obstruction_arm_is_classified_exactly()
    {
        ...
        let cert = crate::normal_form::PrimCert(step.clone());
        ...
        for obstruction in [
            ...
            NormalFormObstruction::CanonicalKeyCollision {
                ...
                depth: crate::boundary::CausalDepth::from(0),
            },
        ] {
            assert_eq!(
        ...
        for obstruction in [
            ...
            NormalFormObstruction::InvalidReplayLevel {
                level: crate::boundary::ReplayLevel::from(0),
                levels: crate::boundary::CausalDepth::from(0),
            },
        ] {
            assert_eq!(
                obstruction_severity(&obstruction),
