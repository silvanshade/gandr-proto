...
//! deciding the ties.
//!
//! [`crate::completion`] turns a divergent critical pair into a derived cell by
//! putting the larger side on the left, and takes
...
/// The **reduction order** — the orientation [`crate::completion`] reads.
///
/// # Contract
...
///   order. [`Ordering::Equal`] everywhere else, which [`crate::completion`]
///   reads as an honest obstruction.
...
///   equality and genuine incomparability, since [`crate::completion`] treats
