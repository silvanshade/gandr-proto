...
mod tests
{
    ...
    use gandr_theory_computads::cell::CellStore;
    use gandr_theory_computads::normal_form::NormalFormObstruction;
    use gandr_theory_computads::normal_form::prim_address;
    use gandr_theory_computads::pathway::certify_candidate;
    use gandr_theory_computads::rewrite::CellApp;
