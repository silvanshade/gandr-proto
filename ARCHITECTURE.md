...
Counting convention: a member is an active entry in the root `Cargo.toml` `workspace.members` list — 45 members over 46 `crates/` directories, the 46th being the parked doc-class tool `workflow-docs` (commented out of the workspace), which no domain row or tier counts.

| Domain       | Crates                                                                                                                                                                                                                                                                                                                      | Role                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| ------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `kernel-*`   | kernel-strata, kernel-conversion-trace, kernel-core                                                                                                                                                                                                                                                                         | the certified trusted core: universe-level oracle; dependency-free conversion-decision vocabulary; S1 term/type language and env                                                                                                                                                                                                                                                                                                                                                                                            |
...
| `surface-*`  | surface-syntax, surface-render-remote, surface-layout, surface-grammar, surface-parser, surface-lsp, surface-engine, surface-diagnostics, surface-repl, surface-tui, surface-corpus, surface-driver                                                                                                                         | user-facing syntax and tools: CST + diffing, inspection wire protocol, the shared document-layout engine, grammar, parser, language-server face, lowering engine with kernel admission, terminal diagnostic facade, read-evaluate loop, terminal face, example corpus, toolchain driver                                                                                                                                                                                                                                     |
...
```text
tier 0   kernel-strata · kernel-conversion-trace · storage-chunker · surface-layout · surface-render-remote
         surface-syntax · theory-graphs · theory-nominal-automata · theory-orders · theory-recursion
tier 1   core-term → kernel-strata, theory-nominal-automata
         kernel-core → kernel-strata, kernel-conversion-trace
         storage-prolly-trees → storage-chunker
         surface-grammar → surface-render-remote, surface-syntax, theory-graphs
         theory-dynamic-graphs → theory-graphs, theory-orders
tier 2   core-checker-tools → core-term
         core-nbe → core-term, kernel-conversion-trace
...
1. **The kernel trusts only itself.** `kernel-core` depends on `kernel-strata` and the dependency-free `kernel-conversion-trace` vocabulary, both inside the `kernel-*` domain; no `kernel-*` crate may gain a dependency outside the domain.
