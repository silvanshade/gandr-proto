...
> Design doctrine — representation, characterization, reasoning style, namespacing, the telescope — is [agda-design.md](agda-design.md); this file is the lane's workflow.
...
The **design doctrine** — how a structure is represented, characterized, reasoned about, and named — is [agda-design.md](agda-design.md): tree-wide rules no single module header can own.
...
This is the same line [agda-design.md](agda-design.md) §"The boundary telescope" draws: **the trusted content is an object-level function with a soundness proof, never a metaprogram**, and nothing in this tree quotes or unquotes syntax.
...
2. **This file and [agda-design.md](agda-design.md)** — a rule that recurred, a gate change, a dependency or commit-shape change.
