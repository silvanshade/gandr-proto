...
**Weak by default; the marks go on strictness and decidability.** Everything reads as weak unless marked; every strict definition carries a definition-site mark, because that is where collapse and the K-floor live and what a trust audit must find.
