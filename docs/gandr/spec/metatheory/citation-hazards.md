...
* **The sheaf-noninterference adequacy proof has a published erratum, and its adequacy theorems are not citable without it** [@sterling-harper-2022-sheaf]: the erratum [@sterling-2023-sheaf-erratum] corrects a mismatch between the existential quantifier and the join of a family of Σ-propositions in the lifting of free algebras to formal approximation relations — reported by the cost-adequacy paper's own related-work text [@niu-sterling-harper-2024-cost-adequacy].
  Theorems 32, 34, and 35 carry the hazard; read the erratum's scope before leaning on any of the three.
