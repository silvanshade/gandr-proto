...
The quantitative sibling: coherence data above a connectivity-determined arity bound is forced rather than assumed (arity approximation), whose applicability to gandr's pattern is a named spike.
