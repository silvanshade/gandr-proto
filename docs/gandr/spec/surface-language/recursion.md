...
Agda's shipped implementation admits proofs of the empty type through sized types, and both demonstrations remain open at the tracker: "Equality is incompatible with sized types" (<https://github.com/agda/agda/issues/2820>, open since October 2017) and "Proof of ⊥ with sized types" (<https://github.com/agda/agda/issues/6002>, open since July 2022); the survey collecting the diagnosis is [@chan-2021-sized-types-state].
