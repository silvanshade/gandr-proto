...
| ---------------------------------------------------------------------------- | ---------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `op` operation members (incl. multi-out)                                     | parse-and-decline                        | the cell layer consumes operation frames (the engine's fusion rung); the multi-out result needs the term face of [[../implementation/multi-out]]                                          |
