...
> **Bialgebra** — copy-then-merge — makes them **expand**: the correspondence paper's own bialgebra case study notes that repeated application of one of its rules "can significantly increase the number of hyperedges", and it needs a four-component lexicographic order to prove termination at all [@bonchi-gadducci-kissinger-sobocinski-zanasi-2022-string-diagram-rewriting-ii, thm 46].
