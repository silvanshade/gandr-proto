...
///   `detail`.
/// - panics: none.
[[nodiscard]] inline std::unexpected<HostError> host_error(ErrorKind kind, std::string detail)
{
...
/// - panics: none.
[[nodiscard]] constexpr std::string_view error_kind_name(ErrorKind kind) noexcept
{
    switch (kind) {
